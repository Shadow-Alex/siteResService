...
type Address struct {
	...
	Mobile       string `orm:"column(mobile);size(50);null" description:"手机"`
	Phone        string `orm:"column(phone);size(255);null" description:"座机"`
	Email        string `orm:"column(email);size(255);null"`
	Postal       string `orm:"column(postal);size(50);null"`
	RegionId     int    `orm:"column(region_id);null"`
	RegionString string `orm:"column(region_string);size(50);null"`
